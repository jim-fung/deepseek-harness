/**
 * Package-owned invariant companion for `@deepseek-ai/dsh-supermemory`.
 * @module @deepseek-ai/dsh-supermemory/invariant
 */

import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-supermemory'

/** Cordis companion plugin name. */
export const name = 'supermemory-bundle-invariant'
