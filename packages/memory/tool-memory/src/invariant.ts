...
/**
 * No runtime invariant: the consumer holds no state — tools delegate to
 * `ctx.memory` per call and recall appends one assembly section, both observed
 * downstream by the session log.
 */
